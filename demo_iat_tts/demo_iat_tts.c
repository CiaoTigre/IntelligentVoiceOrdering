...
int main(int argc, char* argv[])
{
	...
	*/
	...
	const char* recorded_audio_file_path     = "./bin/wav/iflytek01.wav";
	const char* filename                     = "demo_iat_tts.wav"; //合成的语音文件名称
	...
	*/
	...
	ret = text_to_speech(g_result, filename, session_begin_params_tts);
	if (MSP_SUCCESS != ret)
	{
